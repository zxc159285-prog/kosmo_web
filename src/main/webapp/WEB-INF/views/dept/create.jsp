					...
					<form action="/dept/create" method="post">
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">부서명</label> <input
								type="email" name="departmentName" class="form-control"
								id="exampleInputEmail1" aria-describedby="emailHelp">

						</div>
						<div class="mb-3">
							<label for="exampleInputPassword1" class="form-label">관리자아이디</label>
							<input type="password" name="departmentId" class="form-control"
